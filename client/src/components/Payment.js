  ...
  return (
    <div>
      <div class="w-[83%] mx-auto bg-white p-8 border rounded-md shadow-md">
        ...
        <p class="mt-6">
          <span class="text-lg font-semibold">Note:</span> During transactions,
          kindly enter "ASSETS 2024" in the purpose field.
        </p>
        <p class="mt-4">
          <span class="text-lg font-semibold">Note:</span> Registration fee is
          non-refundable. Fee once paid shall not be refunded under any
          circumstances.
        </p>
      </div>
      ...
      {/* <div class="mt-8 max-w-lg mx-auto bg-white p-8 border rounded-md shadow-md">
        <form action="/upload" method="post" enctype="multipart/form-data">
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              type="submit"
              class="ml-4 px-6 py-3 bg-blue-500 text-white rounded-md hover:bg-blue-600"
            >
              Upload Receipt
            </button>
          </div>
