...
function PaperSubmission() {
  return (
    <header>
      <Logo />
      <Navbar />
      <div className='pt-4 font-serif shadow-xl w-800'>
      <div className='text-xl flex items-center ml-8 pt-8 p-4 text-zinc-800 font-bold'>
      ...
      <Link to="https://cvr2021.scrs.in/assets/download/LatexTemplate.zip" className='text-lg text-blue-500 font-bold flex items-center ml-10 p-2 '>Latex Template Download</Link>
      </div>
      </div>
