                ...
                <ul class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
                  <li class="bg-white p-8 rounded-lg shadow-xl  text-gray-800">
                    ...
                    Renewable Energy Sources:
                      </p><ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400 text-justify">
                        <li>
                        ...
                        <li>
                        Wind energy systems and advancements
Bioenergy and biofuels.
                  ...
                  <li class="bg-white p-8 rounded-lg shadow-xl  text-gray-800">
                    ...
                    <p class="text-xl font-bold mb-4">Smart Grids and Energy Storage:

                      </p><ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400 text-justify">
                        <li>
                        Smart grid infrastructure and management
Energy storage technologies (batteries, supercapacitors, etc).

                        </li>
                        <li>Grid integration of renewable energy sources.
                        </li>
                        <li>
...
.
                  ...
                  <li class="bg-white p-8 rounded-lg shadow-xl  text-gray-800">
                    ...
                    <p class="text-xl font-bold mb-4">Energy Conversion Technologies:
                      </p><ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400 text-justify">
                        <li>
                  ...
                  <li class="bg-white p-8 rounded-lg shadow-xl  text-gray-800">
                    ...
                    <p class="text-xl font-bold mb-4">Internet of Things (IoT) in Energy Systems:
                      </p><ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400 text-justify">
                        <li>
...
.
                  ...
                  <li class="bg-white p-8 rounded-lg shadow-xl  text-gray-800">
                    ...
                    <p class="text-xl font-bold mb-4">Energy Policy and Economics
                      </p><ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400 text-justify">
                        <li>
...
.
                        ...
                        <li>
                        Advanced materials for energy devices and
